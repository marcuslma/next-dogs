...
export default function InputText({ label, error, ...props }: InputProps) {
  return (
    <div className="mb-4">
      ...
      <input
        id={props.name}
        className="font-dogs-next-body border border-[#eee] block text-base leading-[1.125rem]
          w-full text-[#333] p-[0.8rem] rounded-[0.4rem] bg-[#eee] transition duration-200
